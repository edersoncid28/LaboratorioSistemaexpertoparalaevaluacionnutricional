...
% Docente: Ing. HUARANCCA ÑAUPARI, Yonny.
% Integrantes
...
% Regla para iniciar el sistema de nutrición
ejecutar_sistema(Genero, Edad, Talla, Peso, NivelHemoglobina, Actividad) :-
    (Genero = 1 -> ejecutar_sistema_hombres(Edad, Talla, Peso, NivelHemoglobina, Actividad);
    ejecutar_sistema_mujeres(Edad, Talla, Peso, NivelHemoglobina, Actividad)).

ejecutar_sistema_hombres(Edad, Talla, Peso, NivelHemoglobina, Actividad) :-
    kilocalorias_hombres(Peso, Talla, Edad, Actividad, Kilocalorias),
